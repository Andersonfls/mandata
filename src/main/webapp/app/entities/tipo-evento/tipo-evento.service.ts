...
type EntityResponseType = HttpResponse<ITipoEvento>;
type EntityArrayResponseType = HttpResponse<ITipoEvento[]>;

@Injectable({ providedIn: 'root' })
export class TipoEventoService {
    public resourceUrl = SERVER_API_URL + 'api/tipo-eventos';
    ...
    update(tipoEvento: ITipoEvento): Observable<EntityResponseType> {
        return this.http.put<ITipoEvento>(this.resourceUrl, tipoEvento, { observe: 'response' });
    }
