...
export class AdvogadoComponent implements OnInit, OnDestroy {
    ...
    registerChangeInAdvogados() {
        this.eventSubscriber = this.eventManager.subscribe('advogadoListModification', response => this.loadAll());
    }
    ...
    protected paginateAdvogados(data: IAdvogado[], headers: HttpHeaders) {
