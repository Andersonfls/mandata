...
export class TipoDocumentoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.tipoDocumentoService
            ...
            .subscribe(
                (res: HttpResponse<ITipoDocumento[]>) => this.paginateTipoDocumentos(res.body, res.headers),
    ...
    protected paginateTipoDocumentos(data: ITipoDocumento[], headers: HttpHeaders) {
