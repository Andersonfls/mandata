...
export class EscritorioComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.escritorioService
            ...
            .subscribe(
                (res: HttpResponse<IEscritorio[]>) => this.paginateEscritorios(res.body, res.headers),
    ...
    trackId(index: number, item: IEscritorio) {
        return item.id;
    }

    registerChangeInEscritorios() {
        this.eventSubscriber = this.eventManager.subscribe('escritorioListModification', response => this.loadAll());
    }
    ...
    protected paginateEscritorios(data: IEscritorio[], headers: HttpHeaders) {
